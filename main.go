...
func (t *ATS) Init(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	stub.PutState("user_type1_2", []byte("XYZ"))
	stub.PutState("user_type1_3", []byte("PQR"))
	stub.PutState("user_type1_4", []byte("IJK"))	
...
func (t *ATS) registerAsset(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *ATS) addDeleteLoadCarried(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *ATS) getLoadCarried(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *ATS) getTransaction(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *ATS) getAllTransaction(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *ATS) getAsset(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *ATS) verifyAsset(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *ATS) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *ATS) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func main() {
	...
	err := shim.Start(new(ATS))
	if err != nil {
		fmt.Printf("Error starting ATS: %s", err)
	}
} 
