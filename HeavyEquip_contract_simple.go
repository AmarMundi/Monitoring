...
type AssetState struct {
	...
	runhours       *string       `json:"hours,omitempty"`          // run hours 
    temperature    *string       `json:"temperature,omitempty"`    // asset temperature
    timestamp      *string       `json:"timestamp,omitempty"`      // time stamp
    carrier        *string       `json:"carrier,omitempty"`        // carrier 
